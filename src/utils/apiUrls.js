...
const apiChatBot = `https://api.spoonacular.com/food/converse?apiKey=${apiKey}&text=`
const baseUrl = 'https://api.spoonacular.com/recipes/'
const randomRecipes = `${baseUrl}random?number=8&apiKey=${apiKey} `
const recipesUrl = `${baseUrl}complexSearch`

export { baseUrl, apiKey, recipesUrl, randomRecipes, apiChatBot }
